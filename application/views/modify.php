        ...
        <form id="calendar_modify"  method="post">
            <div class="container" style="font-size: 15px;padding-top: 15px;padding-left: 15px">
                ...
                <div class="row row_border">
                    ...
                    <div class="col-9">
                        <input type="text" id="start_date" name="start_date" class="form-control" value="<?=date('h:i:s d-m-Y',$detail_info['start_date'])?>"/>
                    </div>
                </div>
                <div class="row row_border">
                    <div class="col-3">
                    ...
                    <div class="col-9">
                        <input type="text" id="end_date" name="end_date" class="form-control" value="<?=date('h:i:s d-m-Y',$detail_info['end_date'])?>"/>
                    </div>
                </div>
                <div class="row row_border">
                    <div class="col-3">
