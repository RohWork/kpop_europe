    <div class="container" style="overflow:auto">
        <form id="calendar_insert">
            ...
            <div class="row mt-1">
                ...
                <div class="col-md-4 col-xs-4 col-md-offset-6 col-xs-offset-4 ">
                    <input type="datetime-local" class="form-control" id="input_start_date" name="input_start_date" value="<?=date("c", strtotime())?>"/>
                </div>
            </div>
            <div class="row mt-1">
                ...
                <div class="col-md-4 col-xs-4 col-md-offset-6 col-xs-offset-4 ">
                    <input type="datetime-local" class="form-control" id="input_end_date" name="input_end_date" value="<?=date("c", strtotime())?>"/>
                </div>
            </div>
            <div class="row mt-1">
