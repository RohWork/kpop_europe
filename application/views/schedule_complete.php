            ...
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <div class="box-footer">
                        <a href="<?php echo site_url('your_controller/excel_upload_form'); ?>" class="btn btn-default">
                            <i class="fa fa-upload"></i> 다시 엑셀 업로드 하기
                        </a>
                        <a href="<?php echo site_url('your_controller/list_page'); ?>" class="btn btn-info pull-right">
